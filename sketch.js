...
function setup() {
  ...
  ground =new Ground(250,height-10,width,20, {isStatic:true, restitution: 5});
  ...
  bunny.scale = 0.2;
  higherground =new Ground(300,170,100,10, {isStatic:true});
  ...
  if(collide(fruit,bubble,40) == true)
    {
      ...
      if(collide(fruit, higherground, 40) == true){
        vaR = false
